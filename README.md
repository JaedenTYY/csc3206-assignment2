...
├── assets/
│   ├── .gitkeep
│   ├── route_output_distance.png    # Generated by --visualize
│   ├── route_output_time.png        # Generated by --cost time --visualize
│   └── route_output_carbon.png      # Generated by --cost carbon --visualize
```
...
- [x] Automated tests pass (26 passing tests, 99% statement coverage with branch tracking enabled.)
